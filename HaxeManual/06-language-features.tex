...
Variable \expr{a} is initialized to an array holding the numbers 0 to 4. The compiler generates code which adds the value of each loop iteration to the array, so the following code would be equivalent:
