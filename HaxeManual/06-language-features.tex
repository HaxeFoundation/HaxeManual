...
If underscore is skipped for trailing optional arguments, then optional arguments will be bound to their default values. To avoid binding optional arguments underscore should be provided for each one.
