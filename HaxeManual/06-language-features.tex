...
Any capture variable can be prefixed with \expr{var}, but in most cases it is unnecessary. Since it also circumvents the warning about potential typos, it is recommended to not use \expr{var} unless necessary.
