...
\trivia{Expression macro-in-macro}{Prior to Haxe 4, using expression macros inside a macro context was possible. Support was dropped because such code would cause issues with the compiler cache.}
