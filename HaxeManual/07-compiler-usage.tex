...
\tablehead{\hline
  ...
  \tabletail{%
    ...
    \hline}
\tablelasttail{\hline}
\begin{supertabular}{|>{\raggedright\arraybackslash}p{.35\linewidth}|>{\raggedright\arraybackslash}p{\dimexpr.65\linewidth-3\arrayrulewidth-4\tabcolsep}|}%
	...
	\expr{swf-compress-level=<1-9>}  &  Set the amount of compression for the SWF output \\
	\expr{swf-debug-password=<pwd>}  &  Set a password for debugging. The password field is encrypted by using the MD5 algorithm and prevents unauthorised debugging of your swf. Without this flag -D fdb will use no password. \\
