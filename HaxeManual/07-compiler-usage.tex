...
\begin{description}
	...
	\item[\ic{-lib library_name}] Adds a \Fullref{haxelib} library. Version will by automatically selected by actual version in the local Haxelib repo. For specify it use \ic{-lib library_name:version}.
