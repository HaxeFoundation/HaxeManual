...
In some situations the user may still want to extend a class marked as final. This is possible by using the \expr{:hack} metadata on the \emph{extending} class. This should be avoided in general, hence the discouraging metadata name \expr{:hack}.
