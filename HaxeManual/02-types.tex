...
\trivia{New function type notation}{The new function type notation was based on the syntax of arrow functions, which were also introduced in Haxe 4.}
\todo{reference the section}
