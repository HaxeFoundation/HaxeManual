...
\label{std-Xml-dot-syntax}

The \href{http://api.haxe.org/haxe/xml/Fast.html}{haxe.xml.Fast} API exists to help by providing a fast dot-syntax access to the most common \type{Xml} methods.
