...
\section{Simplified Xml access}
\label{std-Xml-simplified-access}

%TODO: if this will ever make it to the docs, it needs to be a subsection of Xml %

The \href{http://api.haxe.org/haxe/xml/Fast.html}{haxe.xml.Fast} API exists to provide a fast dot-syntax access to the most common \type{Xml} methods.
