...
Compiling with the `-debug` flag will create a source map (.map) alongside the .js file. Source maps can also be generated for release builds with \ic{-D source-map}. This file is pure for debugging purposes. 
