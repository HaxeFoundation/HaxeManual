...
To expose, apply the \expr{@:expose} metatag on the desired class or static fields.
...
Make sure the Haxe Javascript generated sources are loaded before accessing them.
