...
If you add a file named \ic{extraParams.hxml} to your library root (at the same level as \ic{haxelib.xml}), these parameters will be automatically added to the compilation parameters when someone use your library with \ic{-lib}.
