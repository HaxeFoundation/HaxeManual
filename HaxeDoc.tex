...
\end{description}
As a consequence, the haxe compiler does not allow assigning \expr{null} to a basic type on static targets. In order to achieve this, the basic type has to be wrapped as \type{Null<T>}.  The \emph{\textless{}T\textgreater} is a type parameter.  See \Fullref{Type Parameters} for more details. 
