...
\begin{figure}
	...
	\caption[Variable initialization]{Variable initialization}
\end{figure}
...
If you are targetting a platform that can utilize integer operations, e.g. integer division, for performance gains, wrap the operation in \emph{Std.int()}.  The Haxe compiler can then optimize for integer operations.  An example:
\begin{lstlisting}
...
It is common to see \Fullref{types-structure-class-notation} used with the math library.  This code shows a simple example:  
