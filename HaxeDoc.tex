...
\todo{check whether target restriction info is relevant}
...
\todo{add info on matchedLeft/matchedRight here}
...
\begin{itemize}
    ...
    \item \todo{?} in Flash 6/8, the implementation is not yet available but will a pure Haxe version (hence very slow since it's not native, but compatible)
\end{itemize}
