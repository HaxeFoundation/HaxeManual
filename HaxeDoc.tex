...
\label{Dynamic with Type Parameter}
...
\label{Unification between Class/Interface}
...
\label{Function return unification}
...
\label{Common accessor identifier combinations}
...
\label{Property impact on the type system}
...
\label{rules for getter and setter}
...
\label{Effects of variance and access modifiers}
...
\label{Static extension in the haxe standard library}
...
\label{pattern matching introduction}
...
\label{match on multiple values}
...
\label{Constant expressions as macro arguments}
