...
\paragraph{Globals}
Use the \expr{Template.globals} object to store values that should be applied across all \expr{haxe.Template} instances. This has lower priority than the context argument of \expr{Template.execute}.
