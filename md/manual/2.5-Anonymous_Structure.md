...
Previous section: [Enum Constructors](https://github.com/Simn/HaxeManual/tree/master/md/manual/2.4.1-Enum_Constructors.md)

Next section: [JSON-Notation for Structure Values](https://github.com/Simn/HaxeManual/tree/master/md/manual/2.5.1-JSON-Notation_for_Structure_Values.md)