...
Dynamic behaves in a special way when being [unified](3.3-Unification.md) with a [monomorph](2.9-Monomorph.md), which is described in [Monomorphs](3.3.3-Monomorphs.md).
