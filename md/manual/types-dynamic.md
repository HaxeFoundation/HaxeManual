...
Dynamic behaves in a special way when being [unified](type-systemunification.md) with a [monomorph](types-monomorph.md), which is described in [Monomorphs](type-systemmonomorphs.md).
