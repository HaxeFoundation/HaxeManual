...
* [Constants](5.2-Constants.md)
* [Arrays declarations](5.5-Array_Declaration.md) (if all their elements qualify)
* [Object declarations](5.6-Object_Declaration.md) (if all their field values qualify)
