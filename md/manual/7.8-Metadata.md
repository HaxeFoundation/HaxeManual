...
* Constants ([Constants](5.2-Constants.md))
* Arrays declarations ([Array Declaration](5.5-Array_Declaration.md)) (if all their elements qualify)
* Object declarations ([Object Declaration](5.6-Object_Declaration.md)) (if all their field values qualify)

---

Previous section: [Function Bindings](7.7-Function_Bindings.md)

Next section: [Generic Type Parameters](7.12-Generic_Type_Parameters.md)