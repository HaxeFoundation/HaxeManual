...
2. If the field id declared on an interface ([Interfaces](2.3.3-Interfaces.md)).
3. If the field overrides ([Overriding Fields](4.5-Overriding_Fields.md)) a public field.



More fine-grained control of access can be achieved using [Access Control](7.9-Access_Control.md).
