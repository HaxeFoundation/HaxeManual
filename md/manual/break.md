...
The typer ensures that it appears only within a loop. The `break` keyword in [`switch` cases](switch.md) is not supported in Haxe.

---

Previous section: [return](return.md)

Next section: [continue](continue.md)