...
The function type, along with the [monomorph](2.9-Monomorph.md), is usually well-hidden from haxe users, yet ever present. We can make it surface by using `$type`, a special haxe identifier which outputs during compilation the type of its argument:
