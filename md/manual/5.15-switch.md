...
> This is wrong!  Haxe 3 does some pattern matching magic.  Look at the pattern matching page on haxe.org
...
On some platforms, switches on constant values (especially integers) might be optomized for speed > which platforms?
