...
4. may have [access modifiers](access_modifier.md) (here: `static`)
...
It should be noted that the explicit type is not required if there is an initialization value. The compiler will [infer](type_inference.md) it in this case.

---

Previous section: [Class Fields](class_fields.md)

Next section: [Property](property.md)