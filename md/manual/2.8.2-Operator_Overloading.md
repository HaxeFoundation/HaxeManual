...
```
Similar to implicit casts with class fields ([Implicit Casts](https://github.com/Simn/HaxeManual/tree/master/md/manual/2.8.1-Implicit_Casts.md)), a call to the overload method is inserted where required.
...
Previous section: [Implicit Casts](https://github.com/Simn/HaxeManual/tree/master/md/manual/2.8.1-Implicit_Casts.md)

Next section: [Array Access](https://github.com/Simn/HaxeManual/tree/master/md/manual/2.8.3-Array_Access.md)