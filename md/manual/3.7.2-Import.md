...
Special care has to be taken with field names or local variable names that conflict with a package name: Since they take priority over packages, a local variable named `haxe` blocks the entire `haxe` package.>TODO: I hope there is there a compiler warning about conflicts like this?
