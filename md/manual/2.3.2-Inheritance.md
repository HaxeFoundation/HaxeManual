...
A class may override [Method](4.3-Method.md) of its base class, which requires the explicit `override` keyword. The effects and restrictions of this are detailed in [Overriding Fields](4.5-Overriding_Fields.md).
