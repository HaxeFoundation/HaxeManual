...
A class may override [methods](4.3-Method.md) of its base class, which requires the explicit `override` keyword. The effects and restrictions of this are detailed in [Overriding Fields](4.5-Overriding_Fields.md).

---

Previous section: [Class constructor](2.3.1-Class_constructor.md)

Next section: [Interfaces](2.3.3-Interfaces.md)