...
* the delared [local variables](5.10-var.md)
* the [imported](3.5.2-Import.md) modules, types and statics
...
For step 15 of this algorithm as well as steps 5 and 7 of the previous one, the order of import resolution is important:
...
* For [static extensions](7.2-Static_Extension.md), a match is made if the name equals and the first argument [unifies](3.3-Unification.md). Within a given type being used as static extension, the fields are checked from top to bottom.

---

Previous section: [Import](3.5.2-Import.md)
