...
It should be noted that [top-down inference](top-down_inference.md) is used here to determine the actual type of `T`. There are two requirements for this kind of type parameter construction to work. The constructed type parameter must be



1. generic and
2. be explicitly [constrained](constraints.md) to having a [constructor](class_constructor.md).
...
Previous section: [Generic](generic.md)

Next section: [Variance](variance.md)