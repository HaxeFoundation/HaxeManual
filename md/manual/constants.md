...
Furthermore, the internal syntax structure treats [identifiers](dictionary.md#identifier) as constants, which may be relevant when working with [macros](macros.md).

---

Previous section: [Blocks](blocks.md)

Next section: [Array Declaration](array_declaration.md)