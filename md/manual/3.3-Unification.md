...
* Array declaration: The compiler tries to find a minimal type between all given types in an array declaration. Refer to [Common Base Type](3.3.5-Common_Base_Type.md) for details.
...
Next section: [Between Class/Interface](3.3.1-Between_Class_Interface.md)