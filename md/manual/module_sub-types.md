...
private abstract A { ... }
```
The accessibility can be controlled more fine-grained by using [access control](access_control.md).

---

Previous section: [Modules and Paths](modules_and_paths.md)

Next section: [Import](import.md)