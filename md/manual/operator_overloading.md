...
```
Similar to [implicit casts with class fields](implicit_casts.md), a call to the overload method is inserted where required.
...
Previous section: [Implicit Casts](implicit_casts.md)

Next section: [Array Access](array_access.md)