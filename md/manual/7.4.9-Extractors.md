...
A lcurrent imitation with regards to extractors is that they disable [useless pattern checks](7.4.11-Useless_pattern_checks.md).

---

Previous section: [Match on multiple values](7.4.8-Match_on_multiple_values.md)

Next section: [Exhaustiveness checks](7.4.10-Exhaustiveness_checks.md)