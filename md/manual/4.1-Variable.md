...
4. may have access modifiers ([Access Modifier](4.4-Access_Modifier.md)) (here: `static`)
...
It should be noted that the explicit type is not required if there is an initialization value. The compiler will infer ([Type Inference](3.4-Type_Inference.md)) it in this case.
