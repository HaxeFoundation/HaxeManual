...
It should be noted that the explicit type is not required if there is an initialization value. The compiler will [infer](3.6-Type_Inference.md) it in this case.

---

Previous section: [Class Fields](4-Class_Fields.md)

Next section: [Property](4.2-Property.md)