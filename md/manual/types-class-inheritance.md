...
A class may override [methods](class-field-method.md) of its base class, which requires the explicit `override` keyword. The effects and restrictions of this are detailed in [Overriding Fields](class-field-overriding.md).
