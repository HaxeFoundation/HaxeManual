...
* [Arrays declarations](array_declaration.md) (if all their elements qualify)
* [Object declarations](object_declaration.md) (if all their field values qualify)

---

Previous section: [Function Bindings](function_bindings.md)

Next section: [Access Control](access_control.md)