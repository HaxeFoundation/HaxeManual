...
Previous section: [Useless pattern checks](https://github.com/Simn/HaxeManual/tree/master/md/manual/7.3.10-Useless_pattern_checks.md)

Next section: [Array Comprehension](https://github.com/Simn/HaxeManual/tree/master/md/manual/7.5-Array_Comprehension.md)