...
It should be noted that [top-down inference](type-systemtop-down-inference.md) is used here to determine the actual type of `T`. There are two requirements for this kind of type parameter construction to work. The constructed type parameter must be



1. generic and
2. be explicitly [constrained](type-systemtype-parameter-constraints.md) to having a [constructor](types-class-constructor.md).
...
Previous section: [Generic](type-systemgeneric.md)

Next section: [Variance](type-systemvariance.md)